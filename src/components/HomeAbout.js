...
export default function HomeAbout() {
  return (
    <div class="mx-80 align-left px-12 text-gray-300 pt-12 pb-6 grid md:grid-cols-2">
      <div className="pr-5">
        <h1 className="text-3xl font-bold">Hey! I'm Tom Champlin.</h1>
        <p className="text-lg pt-8">
          I'm a sales rep turned full-stack developer.
        </p>
        <p className="text-lg pt-8">
          I work for TokenTax, helping to simplify crypto taxes for the masses.
          I'm also working on{" "}
      ...
      <div className="pl-5">
        ...
        <div className="pt-8">
          ...
          <p className="mt-3 flex">
            ...
            <a className="my-auto">@tomchamplin1</a>
          </p>
